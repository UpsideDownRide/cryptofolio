...
export const NavItems = ({ isLoggedIn, ...props }) => (
    <React.Fragment>
        ...
        { isLoggedIn ? <NavSettings {...props} /> : null }
    </React.Fragment>
)
...
export const NavSettings = (props) => <NavItem name='settings' {...props}><span style={{ paddingRight: "0.5em" }}>Settings</span><Icon fitted name="cog" /></NavItem>
