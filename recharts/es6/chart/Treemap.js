...
var Treemap = pureRender(_class = (_temp2 = _class2 = function (_Component, _ReactDOM) {
    ...
    _createClass(Treemap, [{
        ...
        value: function componentDidMount() {
            this.setState({ nodeDOM: _ReactDOM.findDOMNode(this) })
        }
    }, {
        ...
        value: function handleMouseEnter(node, e) {
            ...
            var containerOffset = getOffset(this.state.nodeDOM)
            var coords = calculateChartCoordinate(e, containerOffset);

            if (tooltipItem) {
                this.setState({
                    isTooltipActive: true,
                    activeNode: node,
                    activeCoordinates: { x: coords.chartX, y: coords.chartY }
                }, function () {
                    if (onMouseEnter) {
                        onMouseEnter(node, e);
                    }
        ...
        key: 'handleMouseMove',
        value: function handleMouseMove(node, e) {
            var containerOffset = getOffset(this.state.nodeDOM)
            var coords = calculateChartCoordinate(e, { top: containerOffset.top, left: containerOffset.left });
            this.setState({
                activeCoordinates: { x: coords.chartX, y: coords.chartY }
            })
        }
        ...
        value: function renderAnimatedItem(content, nodeProps, isLeaf) {
            ...
            if (isLeaf) {
                event = {
                    ...
                    onMouseMove: this.handleMouseMove.bind(this, nodeProps),
        ...
        value: function renderTooltip() {
            ...
            var coordinate = activeNode ? {
                x: this.state.activeCoordinates.x,
                y: this.state.activeCoordinates.y
            } : null
    ...
    return Treemap;
}(Component, ReactDOM), _class2.displayName = 'Treemap', _class2.propTypes = {
